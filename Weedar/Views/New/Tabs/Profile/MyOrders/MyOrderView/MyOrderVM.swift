...
class MyOrderVM: ObservableObject {
    ...
    @Published var orderDetailsReview: OrderDetailsReview = OrderDetailsReview(orderId: 0, totalSum: 0, exciseTaxSum: 0, salesTaxSum: 0, localTaxSum: 0, discount: 0, taxSum: 0, state: 0)
