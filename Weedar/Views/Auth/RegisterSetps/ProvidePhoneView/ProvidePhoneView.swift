...
struct ProvidePhoneView: View {
    ...
    @StateObject var vm: ProvidePhoneVM
    ...
    var body: some View{
        ...
        //description
        Text("phonenumberview.phone_number_provide_phone_note".localized)
            .lineSpacing(2.8)
            .modifier(TextModifier(font: .coreSansC45Regular, size: 16, foregroundColor: .lightOnSurfaceB, opacity: 0.6))
            .padding(.leading, 24)
            .padding(.top, 12)
            .hLeading()
